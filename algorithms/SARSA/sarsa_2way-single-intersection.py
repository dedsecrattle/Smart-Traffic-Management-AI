...
if __name__ == "__main__":
    ...
    prs.add_argument(
        ...
        dest="route",
        type=str,
        default="sumo-config/2way-single-intersection/single-intersection-gen.rou.xml",
    ...
    write_route_file("sumo-config/2way-single-intersection/single-intersection-gen.rou.xml", 400000, 100000)
    env = SumoEnvironment(
